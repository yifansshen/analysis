function [pSum, pChans, f] = restingIAF_sh(data, nchan, cmin, fRange, Fs, w, Fw, k, varargin)
...
%
% Changed by Simon Hanslmayr to include export of power spectra regardless
% of whether IAF was detected or not; change appears on lines 191-192
%% Outputs:
...
pSum.gSel = sum(selG);
pSum.iaw = iaw;
% export power spectra regardless of whether IAF is detected or not
pSum.ps = pChans(:).d0;
